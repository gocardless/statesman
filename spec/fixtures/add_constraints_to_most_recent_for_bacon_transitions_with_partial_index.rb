class AddConstraintsToMostRecentForBaconTransitions < ActiveRecord::Migration
  ...
  def up
    add_index :bacon_transitions, %i[bacon_id most_recent], unique: true, where: "most_recent", name: "index_bacon_transitions_parent_most_recent", algorithm: :concurrently
