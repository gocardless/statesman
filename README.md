...
be idempotent as it could be called many times. The guard will pass when the 
boolean evaluates to true. On a "falsey" value, eg. false, nil, the guard will fail. 
